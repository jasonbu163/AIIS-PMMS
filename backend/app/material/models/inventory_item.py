...
from sqlalchemy import Boolean, DateTime, Float, ForeignKey, Integer, String, Unicode, func
...
class MaterialInventoryItem(Base):
    ...
    inventory_code: Mapped[str] = mapped_column(Unicode(128), unique=True, nullable=False, index=True)
    ...
    remark: Mapped[str] = mapped_column(Unicode(500), nullable=False, default="")
    source: Mapped[str] = mapped_column(Unicode(255), nullable=False, default="")
    location: Mapped[str] = mapped_column(Unicode(100), nullable=False, default="")
