...
from sqlalchemy import Date, DateTime, Float, ForeignKey, Integer, String, Unicode, func
...
class CuttingPreparationOrder(Base):
    ...
    created_by: Mapped[str] = mapped_column(Unicode(64), nullable=False)
...
class CuttingPreparationItem(Base):
    ...
    sheet_name: Mapped[str] = mapped_column(Unicode(100), nullable=False)
    drawing_path: Mapped[str] = mapped_column(Unicode(500), nullable=False, default="")
